  ...
  render() {
    return (
      <tr className="container_cotation" onClick={this.afficherInfosSupp}>
          ...
          {this.state.statut === "Client" && <td className="infos_cotations_txt_status"><span className="infos_cotations_title">Statut : </span><span className="infos_cotations_value"><div className="rondStatut" style={{"background-color" : "#6c996c"}}></div>Cotation gagnée</span></td>}
